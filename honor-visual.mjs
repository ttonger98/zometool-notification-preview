export function honorBanner(m){
 const star=m.type==='growth_star',period=m.awardPeriod||new Date(m.createdAt+8*3600000).toISOString().slice(0,7);
 ...
 <div class="banner-copy"><span class="banner-kicker">${star?`${period.replace('-',' · ')}  /  成长之星`:'ZOMETOOL  /  创作者荣誉'}</span><strong>${star?'每一份热爱<br>都值得被看见':'共创达人<br>让创意被看见'}</strong><span class="banner-caption">${star?'星云的拼搭故事':'你的分享，点亮更多拼搭灵感'}</span></div>
